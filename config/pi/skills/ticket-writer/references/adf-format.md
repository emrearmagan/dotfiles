...
Markdown → Atlassian Document Format (ADF) conversion reference. Loaded on demand by the `ticket-writer` skill when generating or validating ADF for Jira/Confluence.

Expert guidance for creating, formatting, and validating Atlassian Document Format (ADF) content.

## When to Use This Skill

- Defining valid ADF structure for rich-text content
- Creating ADF documents from plain text or structured requirements
- Validating and correcting malformed ADF JSON
- Standardizing node usage (paragraphs, headings, lists, tables, code blocks)
- User mentions: ADF, Atlassian Document Format, document schema, node format
