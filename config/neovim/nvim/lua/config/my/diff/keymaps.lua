...
function M.setup(buf, actions)
	...
	local entries = {
		...
		{ mode = "n", lhs = "<leader>Rv", desc = "View PR thread", rhs = actions.view_thread },
		{ mode = "n", lhs = "<leader>RV", desc = "View pending review", rhs = actions.view_review },
		{
			mode = "n",
			lhs = "<leader>Ra",
			desc = "Approve PR",
		...
		{ mode = "n", lhs = "<leader>Rr", desc = "Refresh PR comments", rhs = actions.refresh },
		{
			mode = "n",
			lhs = "]c",
		...
		},
		{
			mode = "n",
			lhs = "[n",
			desc = "Previous branch note",
			rhs = function()
				actions.jump_note(-1)
			end,
		},
		{ mode = "n", lhs = "<leader>Rx", desc = "Open PR", rhs = actions.open_pr_url },
	}
